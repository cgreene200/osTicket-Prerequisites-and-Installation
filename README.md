...
## The user will learn how to install and configure all aspects of osTicket open-source ticketing system software and will be able to use the application as, an administrator, a helpdesk technician and as a customer.
